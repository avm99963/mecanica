...
filename = 'q2' # Nom de la imatge resultant (sense extensió)
...
datafile = 'data/q2.dat' # Nom del fitxer de dades que es vol usar
datafitfile = 'data/q2.dat' # Es pot configurar a un altre fitxer si es volen fitar només algunes dades,
...
fit f(x) datafitfile u 3:1 via a, b # Fem el fit de les dades

# Això s'usa per obtenir el valor del coeficient de correlació "r", que estarà guardat a la var. "A_correlation"
stats datafitfile u 3:1 name "A"

# Aquesta funció escriu, a partir dels valors del paràmetres a, b i r, l'equació de la regressió:
title_f(a, b, r) = sprintf('$v = %.1ft + %.1f$, $r = %.3f$', a, b, r);

plot datafile u 3:1:4:2 w xyerr t "Dades experimentals", f(x) t title_f(a, b, A_correlation) # Fem el plot!!
